...
4. Prefer reuse over new abstraction.
5. Identify the smallest set of files and dependencies required.
6. Flag destructive actions and migrations separately.
7. Produce an implementation plan and acceptance checklist.
8. Do not implement.
