...
-- finalize_daily_inventory() is SECURITY DEFINER and rejects NULL auth.uid()
...
SELECT throws_ok(
    $$SELECT public.finalize_daily_inventory('d0000000-0000-0000-0000-000000000001'::uuid)$$,
    'P0001',
